/*
 This Creational design pattern allows a Sequence of Handlers processing an event one after another.
 
 1. A chain of components who all get a chance to process a command or query, optionally having default processing implementation and an ability to terminate the processing chain.
 
 2. Command Query Separation
 3. https://www.youtube.com/watch?v=P9DHX5aBL6I&ab_channel=OptimusGrowth
 4. This pattern allows us to avoid coupling the sender of a request to its receiver by giving multiple objects a chance to handle the request.
 */
