/*
 This structural design pattern, acts as an interface for accessing a particular resource.
 
 In this pattern, proxy is an object to help us to access another object. It simply delegates real job to that object or change its behavior.
 */
...
/*
 ...
 - In case of driving while drunk returns "Not allowed"
